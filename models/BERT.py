...
if __name__ == "__main__":
    ...
    transcript_path = f"data/raw/SCA ST+_diarized.txt"
    ...
    save_validated_words(validated_sca, "keywords/mots_dits_sca.txt")
    save_validated_words(validated_non_sca, "keywords/mots_dits_non_sca.txt")
